...
/**
 * Validador responsável por garantir que a senha escolhida contenha números,
 * caracteres especiais, letras e que tenha no mínimo 7 e no máximo 22
 * caracteres
 */
...
public class PasswordValidator implements Validator {
    ...
    char[] caracteresEspeciais = {'a','A','b','B','c','C','d','D','e','E','f','F','g','G','H','h','i','I','j','J','l','L','m','M','n','N','o','O','p','P','q','Q','r','R','s','S','t','T','u','U','v','V','x','X','z','Z', '"'};
    @Override
